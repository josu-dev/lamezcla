...
<a
  ...
  class="block data-selectable:hover:bg-accent data-selectable:data-selected:bg-accent data-selectable:data-selected:hover:bg-muted/50 rounded-md group focus-outline {classes}"
>
